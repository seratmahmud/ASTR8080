class sdssQuery:
    ...
    url='http://skyserver.sdss.org/dr15/en/tools/search/x_sql.aspx' # JCR 2/27/24 this failed with a broken pipe; add an s 
    url='https://skyserver.sdss.org/dr15/en/tools/search/x_sql.aspx'   
    format = 'csv'
    def __init__(self):
        self.query = ''
        self.cleanQuery = ''
